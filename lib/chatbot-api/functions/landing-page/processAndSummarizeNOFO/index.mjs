...
export const handler = async (event) => {
  ...
  try {
    ...
    console.log("2: Received document from S3", s3Bucket);
    console.log("2: Received document key from S3", documentKey);
