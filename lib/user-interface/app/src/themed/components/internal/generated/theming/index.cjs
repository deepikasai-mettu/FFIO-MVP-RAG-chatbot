module.exports.preset = {
  ...
  "propertiesMap": {
    ...
    "colorBackgroundButtonPrimaryDefault": "--color-background-button-primary-default-jg5g8d",
    ...
    "fontFamilyBase": "--font-family-base-sigkvs",
    ...
    "borderRadiusButton": "--border-radius-button-tsebe0",
